...
Route::group(array('prefix' => 'admin', 'middleware' => 'SentinelAdmin'), function () {
	...
	Route::group(array('prefix' => 'estimates'), function () {
		...
		Route::get('{estimateId}', array('as' => 'estimate/show', 'uses' => 'EstimateController@showEstimate'));
		Route::get('{estimateId}/edit', array('as' => 'estimate/update', 'uses' => 'EstimateController@getUpdate'));
		Route::post('{estimateId}/edit', 'EstimateController@postCreateOrUpdate');
    Route::get('{estimateId}/delete', array('as' => 'estimate/delete', 'uses' => 'EstimateController@getDelete'));
    Route::get('{estimateId}/confirm-delete', array('as' => 'estimate/confirm-delete', 'uses' => 'EstimateController@getModalDelete'));

    Route::get('item/{estimateItemId}/delete', array('as' => 'estimateItem/delete', 'uses' => 'EstimateController@getItemDelete'));
	});

	# Category Management
	Route::group(array('prefix' => 'categories'), function () {
		Route::get('/', array('as' => 'categories', 'uses' => 'CategoryController@getCategories'));
		Route::get('create', array('as' => 'category/create', 'uses' => 'CategoryController@getCreate'));
		Route::post('create', 'CategoryController@postCreate');
		Route::get('{categoryId}', array('as' => 'category/show', 'uses' => 'CategoryController@showCategory'));
		Route::get('{categoryId}/edit', array('as' => 'category/update', 'uses' => 'CategoryController@getUpdate'));
		Route::post('{categoryId}/edit', 'CategoryController@postUpdate');
    Route::get('{categoryId}/delete', array('as' => 'category/delete', 'uses' => 'CategoryController@getDelete'));
    Route::get('{categoryId}/confirm-delete', array('as' => 'category/confirm-delete', 'uses' => 'CategoryController@getModalDelete'));
	});

	# Brand Management
	Route::group(array('prefix' => 'brands'), function () {
		Route::get('/', array('as' => 'brands', 'uses' => 'BrandController@getBrands'));
		Route::get('create', array('as' => 'brand/create', 'uses' => 'BrandController@getCreate'));
		Route::post('create', 'BrandController@postCreate');
		Route::get('{brandId}', array('as' => 'brand/show', 'uses' => 'BrandController@showBrand'));
		Route::get('{brandId}/edit', array('as' => 'brand/update', 'uses' => 'BrandController@getUpdate'));
		Route::post('{brandId}/edit', 'BrandController@postUpdate');
    Route::get('{brandId}/delete', array('as' => 'brand/delete', 'uses' => 'BrandController@getDelete'));
    Route::get('{brandId}/confirm-delete', array('as' => 'brand/confirm-delete', 'uses' => 'BrandController@getModalDelete'));
	});
