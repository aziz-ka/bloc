        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <a href="{{route('users')}}">
                        <i class="fa fa-fw fa-users black"></i>
                    </a>
                </li>
        ...
        <section class="sidebar">
            <div id="menu" role="navigation">
                ...
                <ul class="navigation">
                    ...
                    <li class="menu-dropdown {{ (Request::is('admin/estimates*') || Request::is('admin/ratecards') || Request::is('admin/brands') || Request::is('admin/categories') ? 'active' : '') }}">
                        <a href="#">
                            <i class="menu-icon  fa fa-fw fa-table"></i>
                            <span>Merck Pricing Tool</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="sub-menu">
                            <li {{ (Request::is('admin/estimates') ? 'class=active' : '') }}>
                                <a href="{{ URL::to('admin/estimates') }}">
                                    <i class="fa fa-fw fa-th-list"></i>
                                    All Estimates
                                </a>
                            </li>
                            <li {{ (Request::is('admin/estimates/create') ? 'class=active' : '') }}>
                                <a href="{{ URL::to('admin/estimates/create') }}">
                                    <i class="fa fa-fw fa-plus-square"></i>
                                    Create New Estimate
                                </a>
                            </li>
                            <li {{ (Request::is('admin/ratecards') ? 'class=active' : '') }}>
                                <a href="{{ URL::to('admin/ratecards') }}">
