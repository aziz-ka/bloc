                ...
                <div class="col-xs-12 col-sm-8 ">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('admin-register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Phone Number" class="form-control" name="phone" id="phone"  value="{!! Input::old('phone') !!}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <div class="input-group input-append  date" id="dpYears" data-date="{!! Input::old('dob') !!}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                    <input class="form-control" type="text" value="{!! Input::old('dob') !!}" name="dob" id="dob" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <select name="" id="select2_sample4" class="form-control select2" name="country" id="country">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <textarea rows="3" class="form-control" placeholder="Postal Address" name="address" id="address" value="{!! Input::old('address') !!}"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                <input type="text" class="form-control" id="zip" name="zip" placeholder="Zip Code" value="{!! Input::old('zip') !!}"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-offset-3 col-xs-9">
                                <label class="checkbox-inline mar-left">
                                    <input type="checkbox" name="subscribed" value="1" class="minimal-red" checked/>
