        ...
        <div class="services">
            ...
            <div class="row rcnt-wrk">
                <div class="ih-item square colored effect13 right_to_left">
                    <a href="#">
                        <div class="img"><img src="{{ asset('assets/images/recent_works/5.jpg') }}" class="img-responsive"></div>
                        <div class="info">
                ...
                <div class="ih-item square colored effect13 right_to_left">
                    <a href="#">
                        <div class="img"><img src="{{ asset('assets/images/recent_works/6.jpg') }}" class="img-responsive"></div>
                        <div class="info">
                ...
                <div class="ih-item square colored effect13 right_to_left">
                    <a href="#">
                        <div class="img"><img src="{{ asset('assets/images/recent_works/7.jpg') }}" class="img-responsive"></div>
                        <div class="info">
                ...
                <div class="ih-item square colored effect13 right_to_left">
                    <a href="#">
                        <div class="img"><img src="{{ asset('assets/images/recent_works/8.jpg') }}" class="img-responsive"></div>
                        <div class="info">
